...
export const Skills = () => (
  <div className="flex flex-col gap-2">
    ...
    <p className="p-4 rounded-md bg-stone-800">
      I'm excited to showcase the skills that make me a passionate and versatile
      developer. My journey in the world of web development has been an exciting
      one, and I've honed my abilities to create awesome, user-friendly, and
      efficient applications. Here's a glimpse of the skills I bring to the
      table:
    </p>
